...
func (res *OrderResource) postponedOrder(w http.ResponseWriter, r *http.Request) {

	var request dto.PostponedOrderRequest
	var err error
	...
	err = res.orderMan.Postponed(r.Context(), request.Ids, userId)
	if err != nil {
		_ = render.Render(w, r, httperrors.BadRequest(err))
		return
	}

...
func (res *OrderResource) returnOrder(w http.ResponseWriter, r *http.Request) {

	var request dto.ReturnOrderRequest
	var err error
	...
	err = res.orderMan.Return(r.Context(), request.Ids, userId)
	if err != nil {
		_ = render.Render(w, r, httperrors.BadRequest(err))
		return
	}

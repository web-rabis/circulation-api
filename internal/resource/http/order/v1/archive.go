...
func (res *OrderResource) archiveOrder(w http.ResponseWriter, r *http.Request) {

	var request dto.ArchiveOrderRequest
	var err error
	...
	err = res.orderMan.Archive(r.Context(), request.Ids, userId)
	if err != nil {
		_ = render.Render(w, r, httperrors.BadRequest(err))
		return
	}

...
func (res *OrderResource) issueOrders(w http.ResponseWriter, r *http.Request) {

	var request dto.IssueOrdersRequest
	var err error
	...
	err = res.orderMan.IssueOrders(r.Context(), request.Ids, userId)
	if err != nil {
		_ = render.Render(w, r, httperrors.BadRequest(err))
		return
	}
